...
export const portfolioData = {
  ...
  experience: [
    {role:'Associate Software Developer — Java Backend',company:'Rumango Software Consultancy',location:'Bangalore',period:'Nov 2024 — Present',highlights:['Delivered backend features for 2 enterprise platforms using Java, Spring Boot, REST APIs, JPA/Hibernate, JDBC, and SQL.','Engineered 30+ REST APIs with validation, centralized error handling, repository integration, and Postman testing.','Automated customer onboarding and internal workflows, reducing manual effort by 70%.','Optimized SQL queries and service-layer logic, improving response performance by 25%.','Resolved 15+ production issues and integrated CRB, IPRS, and Flexcube external systems.','Orchestrated approval workflows across 8+ business modules.']},
    {role:'Java Full Stack Developer Intern',company:'Tap Academy Pvt. Ltd.',location:'Bengaluru',period:'Nov 2023 — Oct 2024',highlights:['Completed an 11-month internship covering Core Java, OOP, JDBC, Servlets, JSP, Spring Boot, and MySQL.','Built REST APIs using controller, service, and repository layers.','Designed MySQL schemas and queries for CRUD, joins, and filtering.','Handled API testing, request validation, and database operations.']},
  ],
  projects: [
